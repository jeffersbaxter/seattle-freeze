        ...
        <>
            ...
            <div className="add-review-form">
                ...
                <form onSubmit={handleFormSubmit}>
                    ...
                    <label>
                        Experience:
                        <select name="experienceId" disabled value={formData.experienceId} onChange={handleInputChange}>
                    ...
                    <label>
                        Patron:
                        <select name="patronId" disabled value={formData.patronId} onChange={handleInputChange}>
